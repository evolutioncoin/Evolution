...
namespace WalletConfig
{
    ...
    const std::string_view addressPrefix = "evc";

    /* Your coins 'Ticker', e.g. Monero = XMR, Bitcoin = BTC */
    const std::string ticker = "EVC";
    ...
    const std::string daemonName = "Evolutiond";
    ...
    /* The name of service/walletd, the programmatic rpc interface to a
       wallet */
    const std::string walletdName = "wallet-service";

    /* The full name of your crypto */
    const std::string coinName = std::string(CryptoNote::CRYPTONOTE_NAME);

    /* Where can your users contact you for support? E.g. discord */
    const std::string contactLink = "http://Evolutioncoin.go.ro/chat/ OR https://discord.gg/A6Z5mfT";
	...
	const int numDisplayDecimalPlaces = CryptoNote::parameters
    ...
    const size_t saveWalletEveryNBlocks = 5000; // idk what the fuck this is, i think saves checkpoints so it can load faster
}
