# USAGE: Start wallet-service as you usually would
...
from evolution import Walletd as Wallet
import time
import argparse
parser = argparse.ArgumentParser()
parser.add_argument("--address", help="Evolution address to optimize", required=True)
