...
function usage()
{
    ...
    echo "and generates the checksum files of the Evolution tag provided."
    echo
...
# -- Config
GITHUB_REPO="https://github.com/evolutioncoin/evolution.git"
CLONE_DIR="$BUILD_DIRECTORY/evolution-buildall"
TARGET_DIR="$BUILD_DIRECTORY/evolution-releases"
DYNAMIC_RELEASE="evolution-${TAG_VERSION}-linux-CLI"
STATIC_RELEASE="evolution-${TAG_VERSION}-linux-staticboost-CLI"
